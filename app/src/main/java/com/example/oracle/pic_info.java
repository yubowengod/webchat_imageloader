...
public class pic_info {
    ...
    public static void getImageromSdk(String flag,String update_user){
        try{
            String methodName = "selectAll_UPDATE_USER_INFO";
            getImageFromAndroid(methodName,flag,update_user);   //调用webservice
    ...
    public static String getImageFromAndroid(String methodName,String flag,String update_user){
        Log.i("进入端口方法", "进入端口方法");
        ...
        try {
            ...
            soapObject.addProperty("UPDATE_USER",update_user);
